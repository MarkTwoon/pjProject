...
<!-- 行为验证的前端示范页面 http://localhost:8080/gt-java-sdk/login.jsp-->
<div class="popup">
...
<script>
    ...
    $.ajax({
        url: "admin/register2?t=" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
        success: function (data) {
            // 使用initGeetest接口
            ...
            initGeetest({
                ...
                product: "popup", // 产品形式，包括：float，embed，popup。注意只对PC版验证码有效 触发式、嵌入式、弹出式
