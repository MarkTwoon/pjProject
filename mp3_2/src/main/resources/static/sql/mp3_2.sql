...
Source Database       : mp3_2

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2020-10-16 17:10:45
*/
...
CREATE TABLE `tb_admin` (
  ...
  `ADMIN_NAME` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '管理员账号  姓名',
  `ADMIN_PHONE` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '管理员手机号  联系电话',
  `ADMIN_PASSWORD` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '管理员登录密码',
  `ADMIN_SEX` varchar(255) COLLATE utf8_bin NOT NULL COMMENT '管理员性别',
...
CREATE TABLE `tb_mp3` (
  ...
  `MP3_NAME` varchar(255) COLLATE utf8_bin NOT NULL,
  `MP3_MAN` varchar(255) COLLATE utf8_bin NOT NULL,
  `MP3_MANIMG` varchar(255) COLLATE utf8_bin NOT NULL,
  `MP3_SRC` varchar(255) COLLATE utf8_bin NOT NULL,
  `MP3_BIG` varchar(255) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `tb_mp3` VALUES ('42', '测试歌曲01', '测试歌手01', '/upload/202010/95dff74205124d7ba0b7a2c0a408aa27.png', '/upload/202010/fb755eda65c944439ed4d75bbec8c94c.mp3', '1.4MB');
INSERT INTO `tb_mp3` VALUES ('43', '测试歌曲102', '测试歌手102', '/upload/202010/984fec17181844dfae411d3cf9bbfcbd.jpg', '/upload/202010/88309dde2a2e451894cdf484bbc260a5.mp3', '1.5MB');
